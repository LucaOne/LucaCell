...
# DATASET_NAME="cellxgene_kidney_finetune_lucacellv2_monkeytest"
DATASET_TYPE="cell"

# for task
TASK_TYPE="multi_class"
TASK_LEVEL_TYPE="cell_level"
LABEL_TYPE="cellxgene_kidney_finetune_lucacellv2_2_rmMouse_1"
# LABEL_TYPE="cellxgene_kidney_finetune_lucacellv2_monkeytest"
...
seq_vector_dirpath="../../embedding/lucacellv2/lucacell-2048pos/v1.0/kidney/human_ATAC_gene_seq_embeddings/#../../embedding/gene_seq_embeddings_lucaone_60000000/"
# seq_matrix_dirpath=""
...
#cell_llm_time_str=20250726103509
...
## pos_weight
# weight=2,1,1,2,1,1,1,1,2
# weight=2,1,1,2,4,1,1,1,1,1
weight=1,2,1,1,1,1,5,1,1,2,1
## loss_reduction
loss_reduction="mean"
## num_labels
num_labels=11
...
python run.py \
  ...
  --test_data_dir ../dataset/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/test/#../dataset/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/val2/#../dataset/$DATASET_NAME/$DATASET_TYPE/$TASK_TYPE/test2/ \
