...
LABEL_TYPE="onek1k_lucacellv2_expr_nosnp_cls_noXY_egenes"
...
seq_vector_dirpath="../../embedding/gene_seq_embeddings_cls_60M/"
...
cell_matrix_dirpath="../../embedding/lucacellv2/lucacell-2048pos/v1.0/onek1k_noXY_egenes/cell_embeddings_nosnp_cls_6400000/"
