...
class LucaBase(BertPreTrainedModel):
    def __init__(self, config, args):
        ...
        self.cell_prepend_bos = args.cell_prepend_bos
        self.cell_append_eos = args.cell_append_eos
        ...
        if self.input_type == "seq":
            ...
            self.seq_encoder = LucaTransformer(config, use_pretrained_embedding=False, add_pooling_layer=(args.seq_pooling_type is None or args.seq_pooling_type == "none") and self.task_level_type in ["cell_level"])
