...
sys.path.append("../../../../src")
try:
    from llm.lucacell.common.classification_loss import *
    from llm.lucacell.common.regression_loss import *
except ImportError:
    from src.llm.lucacell.common.classification_loss import *
    from src.llm.lucacell.common.regression_loss import *
        ...
        if output_mode in ["regression"]:
            ...
            if loss_type == "bce":
                ...
                loss_fct = MaskedAsymmetricLossOptimized(
                    gamma_neg=args.asl_gamma_neg if hasattr(args, "asl_gamma_neg") else 4.0,
