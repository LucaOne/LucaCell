...
sys.path.append("../../../../src")
try:
    from llm.lucacell.common.loss import *
    ...
    from src.llm.lucacell.common.loss import *
...
class LucaCell(nn.Module):
    def __init__(
        ...
        self.alphabet = Alphabet.from_predefined(
            ...
            tokenizer_dir=None,
            use_express_sorted=args is not None and hasattr(args, "express_sorted_list_filepath") and args.express_sorted_list_filepath is not None,
        )
