...
python get_embedding.py \
    ...
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/hg38.ensGene_genes_split/hg38.ensGene_genes_short_part_1_of_4.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/hg38.ensGene_genes/matrix/ \
    --save_type tensor \
...
python get_embedding.py \
    ...
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/hg38.ensGene_genes_split/hg38.ensGene_genes_short_part_2_of_4.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/hg38.ensGene_genes/matrix2/ \
    --save_type tensor \
    --embedding_type matrix \
    --matrix_add_special_token \
    --embedding_complete \
...
python get_embedding.py \
    ...
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/hg38.ensGene_genes_split/hg38.ensGene_genes_short_part_3_of_4.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/hg38.ensGene_genes/matrix/ \
    --save_type tensor \
    --embedding_type matrix \
    --matrix_add_special_token \
...
python get_embedding.py \
    ...
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/hg38.ensGene_genes_split/hg38.ensGene_genes_short_part_4_of_4.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/hg38.ensGene_genes/matrix/ \
    --save_type tensor \
    --embedding_type matrix \
    --matrix_add_special_token \
...
python get_embedding.py \
    ...
    --llm_version lucaone-gene \
    --llm_step 36800000 \
    --truncation_seq_length 10250 \
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/hg38.ensGene_genes_split/hg38.ensGene_genes_long_part_1_of_1.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/hg38.ensGene_genes/matrix/ \
    --save_type tensor \
    --embedding_type matrix \
    --matrix_add_special_token \
...
python get_embedding.py \
    ...
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/mm10.ensGene_genes_split/mm10.ensGene_genes_short_part_1_of_4.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/mm10.ensGene_genes/matrix/ \
    --save_type tensor \
    --embedding_type matrix \
    --matrix_add_special_token \
    --embedding_complete \
...
python get_embedding.py \
    ...
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/mm10.ensGene_genes_split/mm10.ensGene_genes_short_part_2_of_4.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/mm10.ensGene_genes/matrix/ \
    --save_type tensor \
    --embedding_type matrix \
    --matrix_add_special_token \
...
python get_embedding.py \
    ...
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/mm10.ensGene_genes_split/mm10.ensGene_genes_short_part_3_of_4.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/mm10.ensGene_genes/matrix/ \
    --save_type tensor \
    --embedding_type matrix \
    --matrix_add_special_token \
...
python get_embedding.py \
    ...
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/mm10.ensGene_genes_split/mm10.ensGene_genes_short_part_4_of_4.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/mm10.ensGene_genes/matrix/ \
    --save_type tensor \
    --embedding_type matrix \
    --matrix_add_special_token \
...
python get_embedding.py \
    ...
    --trunc_type right \
    --seq_type gene \
    --input_file ../../meta/mm10.ensGene_genes_split/mm10.ensGene_genes_long_part_1_of_1.fasta \
    --save_path ../../../embedding/lucaone-gene/meta/mm10.ensGene_genes/matrix/ \
    --save_type tensor \
    --embedding_type matrix \
    --matrix_add_special_token \
