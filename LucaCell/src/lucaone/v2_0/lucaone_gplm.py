...
sys.path.append("../../../src")
try:
    from lucaone.common.loss import *
    from lucaone.v2_0.model_utils import AllOutput, create_output_loss_lucagplm
    from lucaone.v2_0.alphabet import Alphabet
    from lucaone.v2_0.modeling_gplm import *
except ImportError:
    from src.lucaone.common.loss import *
    from src.lucaone.v2_0.model_utils import AllOutput, create_output_loss_lucagplm
    from src.lucaone.v2_0.alphabet import Alphabet
    from src.lucaone.v2_0.modeling_gplm import *
...
class LucaGPLM(nn.Module):
    ...
    def _init_submodules(self):
        ...
        if self.use_last_layer_norm:
            self.last_layer_norm = LucaGPLM1bLayerNorm(self.embed_dim, eps=1e-8)
        else:
