...
try:
    ...
    from lucaone.v2_0.alphabet import Alphabet as AlphabetLucaOne
    ...
    from src.lucaone.v2_0.alphabet import Alphabet as AlphabetLucaOne
...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        choices=["5600000", "17600000", "30000000", "36000000", "36800000", "60000000"],
...
def embedding_for_one_sample(model_args):
    ...
    if global_model is None:
        ...
        if model_args.llm_step is None or model_args.llm_step not in ["5600000", "17600000", "30000000", "36000000" "36800000", "60000000"]:
            if model_args.llm_version == "lucaone":
                model_args.llm_step = "60000000"
